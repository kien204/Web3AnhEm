...
const addStory = async () => {
    if (validateForm()) {
        try {
            ...
            storyList.value.push(newStoryData);
            resetForm();
    ...
    <div>
        <div class="card">
            ...
            <DataTable
                ...
                currentPageReportTemplate="Showing {first} to {last} of {totalRecords} stories"
            >
                <template #header>
                ...
                <template #expansion="slotProps">
                    <div class="p-3">
                        ...
                        <DataTable :value="getChaptersForStory(slotProps.data.storyCode)" responsiveLayout="scroll" :globalFilterFields="['chapterName', 'chapterCode']" :filters="filtersChapter">
                            ...
                            <Column field="episodeNumber" header="Số Tập" />
                        </DataTable>
                    </div>
                </template>
            </DataTable>
